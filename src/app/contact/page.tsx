            ...
            <div className='lg:h-4/5'>
                <main className='h-full main grid lg:grid-cols-2'>
                    ...
                    <div className="flex flex-col justify-center items-center">
                        <h4 className="mb-4 text-center">Got Questions, Ideas, or Just Want to Say 'Hi'?<br/> Drop Me an Email at <span className='font-bold text-2xl '>hola@haroldesigner.art</span><br/> I’m All Ears (and Inbox)!</h4>
